   ...
   public void close() {
      if (!this.closed) {
         ...
         if (this.targets.length > 0) {
            GL13.glActiveTexture('蓀' + this.unit);
         ...
         GL13.glActiveTexture('蓀' + this.previousActiveUnit);
      }
   }
